...
def initialize_model(model_name, num_classes, feature_extract, use_pretrained=True):
    ...
    if model_name == "resnet50":
        ...
        input_size = 224
        print("Chosen model: DenseNet201") 
...
def train_model(model, dataloaders, device, criterion, scheduler, optimizer, num_epochs, is_inception):
    since = time.time()
